...
public class HumanVsHuman6x6 {
    ...
    public void moveAndLightUp(int i, int j) {
        if (matrix.board[i][j] == turn) { //black er turn na hole black chaple dekhabe na kichu
            if (thinking) {
